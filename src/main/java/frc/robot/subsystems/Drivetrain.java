...
public class Drivetrain extends SubsystemBase {
    ...
    public CANSparkMax leftMotorMaster = new CANSparkMax(Constants.LEFT_MOTOR_MASTER, MotorType.kBrushless);
    public CANSparkMax rightMotorMaster = new CANSparkMax(Constants.RIGHT_MOTOR_MASTER, MotorType.kBrushless);
    ...
    // final DifferentialDrive m_drive = new DifferentialDrive(leftMotorMaster,
    // rightMotorMaster);
    ...
    // Encoder(Constants.kRightEncoderPorts[0], Constants.kRightEncoderPorts[1],
    ...
    public void checkMotorOutput() {
        System.out.println("Left Master:" + leftMotorMaster.getOutputCurrent());
        System.out.println("Left Slave:" + leftMotorSlave.getOutputCurrent());
        System.out.println("Right Master:" + rightMotorMaster.getOutputCurrent());
        System.out.println("Right Slave:" + rightMotorSlave.getOutputCurrent());
    }
